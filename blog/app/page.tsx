  ...
  return (
    <div className="home-page bg-gray-100 min-h-screen">
      <header className="header bg-white shadow-md p-4 flex justify-between items-center">
        <a href="/" className="logo text-xl font-bold">Nom de l'entreprise</a>
        <nav className="nav flex items-center">
          <a href="/about" className="nav-link mr-4">À propos</a>
          <a href="/services" className="nav-link mr-4">Services</a>
          <a href="/contact" className="nav-link">Contact</a>
        </nav>
      </header>
      <main className="main p-10">
        <section className="hero flex flex-col justify-center items-center mb-10">
          <h1 className="text-4xl font-bold mb-4">Titre accrocheur</h1>
          <p className="text-gray-600 text-lg leading-relaxed">Slogan ou description de l'entreprise</p>
          <a href="/contact" className="btn bg-blue-500 text-white px-4 py-2 mt-4">Contactez-nous</a>
        </section>
        <section className="about grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center items-center">
            <img src="/image.jpg" alt="Image de l'entreprise" className="w-48 mx-auto" />
          </div>
          <div>
        ...
        <section className="services bg-gray-200 p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="service p-4 shadow-md rounded-md">
              <h3 className="text-xl font-bold mb-2">Titre du service 1</h3>
              <p className="text-gray-600 text-lg leading-relaxed">Description du service 1</p>
            </div>
            <div className="service p-4 shadow-md rounded-md">
              <h3 className="text-xl font-bold mb-2">Titre du service 2</h3>
              <p className="text-gray-600 text-lg leading-relaxed">Description du service 2</p>
            </div>
            <div className="service p-4 shadow-md rounded-md">
              <h3 className="text-xl font-bold mb-2">Titre du service 3</h3>
              <p className="text-gray-600 text-lg leading-relaxed">Description du service 3</p>
            </div>
          </div>
        </section>
